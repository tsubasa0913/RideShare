...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        private final AndroidxGoogleLibraryAccessors laccForAndroidxGoogleLibraryAccessors = new AndroidxGoogleLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.google</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidxGoogleLibraryAccessors getGoogle() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidxGoogleLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidxGoogleLibraryAccessors extends SubDependencyFactory {
        private final AndroidxGooglePlayLibraryAccessors laccForAndroidxGooglePlayLibraryAccessors = new AndroidxGooglePlayLibraryAccessors(owner);

        public AndroidxGoogleLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.google.play</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidxGooglePlayLibraryAccessors getPlay() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidxGooglePlayLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidxGooglePlayLibraryAccessors extends SubDependencyFactory {
        private final AndroidxGooglePlayServicesLibraryAccessors laccForAndroidxGooglePlayServicesLibraryAccessors = new AndroidxGooglePlayServicesLibraryAccessors(owner);

        public AndroidxGooglePlayLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.google.play.services</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidxGooglePlayServicesLibraryAccessors getServices() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidxGooglePlayServicesLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidxGooglePlayServicesLibraryAccessors extends SubDependencyFactory {

        public AndroidxGooglePlayServicesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getAuth() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.google.play.services.auth");
        }
    ...
    public static class PlayServicesVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>play.services.auth</b> with value <b>21.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
