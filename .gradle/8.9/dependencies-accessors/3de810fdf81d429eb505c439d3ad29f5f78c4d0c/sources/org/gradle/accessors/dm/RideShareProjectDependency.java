...
@NonNullApi
public class RideShareProjectDependency extends DelegatingProjectDependency {

    @Inject
    public RideShareProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
